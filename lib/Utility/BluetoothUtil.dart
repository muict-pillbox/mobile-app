...
class BlueoothUtil extends StatefulWidget {
  final BluetoothDevice server;

  const BlueoothUtil({required this.server});

  @override
  _BlueoothUtil createState() => new _BlueoothUtil();
}
...
class _BlueoothUtil extends State<BlueoothUtil> {
